...
CM_SORTING_NumAZ = _OriginExt.CM_SORTING_NumAZ
...
OCD_DEL_NO_UPDATE_RANGE = _OriginExt.OCD_DEL_NO_UPDATE_RANGE
OCD_DEL_NO_CHECK_SHDF = _OriginExt.OCD_DEL_NO_CHECK_SHDF
...
class OriginCollectionGraphObjects(OriginCollectionBase):
    ...
    def Add(self, nType):
        return _OriginExt.OriginCollectionGraphObjects_Add(self, nType)
